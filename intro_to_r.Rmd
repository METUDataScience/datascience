...
The website you see now is a rendered HTML file. If you want to play with the .Rmd file, you can go to the [original repository](https://github.com/makyol/datascience), download the .Rmd file and run it on RStudio. 
